...
# 守护进程控制脚本, 借鉴彭老师的实现, 本人也是极客时间AI Agent的二期学员
# https://github.com/DjangoPeng/GitHubSentinel/blob/main/daemon_control.sh
...
# 定义守护进程 Python 脚本的路径
# DAEMON_PATH="./geeknews/daemon_process.py"
# 定义守护进程的名称
DAEMON_NAME="geeknews"
# 定义日志文件的路径 (expend user)
LOG_DIR=$(expand_path "~/log")
