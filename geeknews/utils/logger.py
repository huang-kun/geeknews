...
# https://github.com/DjangoPeng/GitHubSentinel/blob/main/src/logger.py
...
app_log_path = os.path.expanduser('~/log/geeknews/app.log')
logger.add(app_log_path, rotation="1 MB", level=os.getenv('LOG_LEVEL', 'INFO'), format=log_format)
