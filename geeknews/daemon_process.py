...
def hacker_news_daily_job(geeknews_manager: GeeknewsManager, override_content=True, debug_send_email=False):
    ...
    #     geeknews_manager.hackernews_manager.api_client.clean_local_items(date)
...
def hacker_news_preview_job(geeknews_manager: GeeknewsManager):
    ...
    preview_json_path = geeknews_manager.hackernews_manager.generate_preview_json(date, locale)
